...
//// https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=841&page=show_problem&problem=4089
//// Rujia Liu
...
//
///**
// *  比较中间8个数与target不同的个数，target为1，2，3
// *
// *  @param target 1，2，3
// *
// *  @return 不同的个数
